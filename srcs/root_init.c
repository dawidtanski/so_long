...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/24 14:53:54 by dtanski           #+#    #+#             */
/*   Updated: 2024/09/25 14:27:58 by dtanski          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	texture_load(root, &root->player, "./assets/textures/Player/dog.xpm");
	texture_load(root, &root->exit, "./assets/textures/Exit/kennel.xpm");
	texture_load(root, &root->coll, "./assets/textures/Collectibles/bone3.xpm");
	texture_load(root, &root->wall, "./assets/textures/Tiles/water.xpm");
	texture_load(root, &root->ground, "./assets/textures/Background/background.xpm");
}	
